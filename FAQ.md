...
#### Для версий приложения 2.2 или выше:
Папка пользователя\AppData\Roaming\SPT-AKI Profile Editor
%AppData%\SPT-AKI Profile Editor (нажмите WIN + R, скопируйте в появившееся окно этот путь и нажмите Enter, или запустите программу, Настройки - Устранение проблем - Открыть папку данных приложения)
Backups - бэкапы профилей
Localizations - локализации приложения
Logs - логи приложения
AppSettings.json - настройки приложения