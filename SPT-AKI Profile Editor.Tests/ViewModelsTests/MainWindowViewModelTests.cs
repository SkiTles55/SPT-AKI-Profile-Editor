...
namespace SPT_AKI_Profile_Editor.Tests.ViewModelsTests
{
    internal class MainWindowViewModelTests
    {
        ...
        private static readonly TestsHelperModManager helperModManager = new();

        [Test]
        public void InitializeCorrectly()
        {
            MainWindowViewModel _viewModel = new(applicationManager, null, helperModManager, dialogManager);
        ...
        {
            dialogManager.SettingsDialogOpened = false;
            MainWindowViewModel _viewModel = new(applicationManager, null, helperModManager, dialogManager, worker);
