...
namespace SPT_AKI_Profile_Editor.Tests.ViewModelsTests
{
    internal class StashTabViewModelTests
    {
        ...
        {
            StashTabViewModel viewModel = new(new TestsDialogManager(), null);
        ...
        {
            Assert.That(StashTabViewModel.AppSettings, Is.Not.Null);
            Assert.That(StashTabViewModel.OpenContainer, Is.Not.Null);
            Assert.That(StashTabViewModel.InspectWeapon, Is.Not.Null);
        }
        ...
        public void CanAddItem()
        {
            ...
            StashTabViewModel viewModel = new(new TestsDialogManager(), new TestsWorker());
