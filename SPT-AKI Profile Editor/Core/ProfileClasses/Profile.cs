    ...
    public class Profile : BindableEntity
    {
        ...
        public void Load(string path)
        {
            ...
            void SetupQuest(CharacterQuest quest)
            {
                ...
                if (AppData.ServerDatabase.LocalesGlobal.ContainsKey(quest.Qid.Name()) || profile.Characters.Pmc.RepeatableQuests == null || profile.Characters.Pmc.RepeatableQuests.Length == 0)
                {
