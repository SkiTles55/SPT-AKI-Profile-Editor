...
namespace SPT_AKI_Profile_Editor.Core
{
    public class AppSettings(string configurationFile) : BindableEntity
    {
        ...
        [JsonIgnore]
        public readonly string modHelperUpdateUrl = "https://raw.githubusercontent.com/SkiTles55/SPT-AKI-Profile-Editor/master/SPT-AKI%20Profile%20Editor.ModHelper/bin/Release/net10.0/";
