        ...
        public static List<AppLocalization> DefaultLocalizations => new()
        {
            new AppLocalization
            {
                ...
                Translations = new Dictionary<string, string>()
                {
                    ...
                    ["tab_settings_auto_add_event_quests"] = "Adding missing event quests to the profile",
                    ...
                    ["tab_hideout_zones"] = "Zones",
                    ["tab_hideout_crafts"] = "Crafts",
                    ["tab_hideout_end_product"] = "End product",
                    ["tab_hideout_area"] = "Area",
                    ["tab_hideout_level"] = "Level",
                    ["tab_hideout_maximum_button"] = "Set everything to maximum",
                    ["tab_hideout_add_all_crafts"] = "Add all crafts",
                    ...
                    ["tab_stash_modded_item_founded_error"] = "Item added by mod found. Use the section \"Cleaning from mods\" to remove such items.",
                    ["tab_stash_quest_item"] = "Quest item",
                    ["tab_stash_add_to"] = "Add to",
                    ["tab_stash_search_include_description"] = "Search in description",
                    ["tab_stash_all_items"] = "All items",
                    ["stash_type_stash"] = "PMC stash",
                    ["stash_type_questraiditems"] = "Quest items in inventory (in-raid)",
                    ["stash_type_queststashitems"] = "Quest item special stash (off-raid)",
                    ["all_items_description"] = "This function allows you to add any item from the server DB",
                    ["all_items_warning"] = "Some items may damage the profile. Use at your own risk!",
                    ["tab_clearing_from_mods_title"] = "Cleaning from mods",
                    ["tab_clearing_from_mods_tpl"] = "TPL",
                    ...
                    ["tab_clearing_from_mods_weapon_build"] = "Weapon build",
                    ["tab_clearing_from_mods_equipment_build"] = "Equipment build",
                    ...
                    ["tab_clearing_from_mods_helper_mod_enabled"] = "Enabled use helper mod. In this mode, only the remains of deleted mods are displayed. You can disable the use helper mod in the settings",
                    ...
                    ["profile_saved_with_errors_dialog_caption"] = "Profile saved with errors",
                    ["profile_not_saved_dialog_caption"] = "Failed to save profile",
                    ...
                    ["tab_presets_weapon_user"] = "Weapon (User)",
                    ["tab_presets_weapon_global"] = "Weapon (Global)",
                    ["tab_presets_equipment_user"] = "Equipment (Global)",
                    ["tab_presets_export"] = "Export",
                    ["tab_presets_import"] = "Import",
                    ["tab_presets_add_to_stash"] = "Add to stash",
                    ["tab_presets_weapons_empty"] = "Profile does not have any weapon builds",
                    ["tab_presets_equipment_empty"] = "Profile does not have any equipment presets",
                    ["tab_presets_file_not_build"] = "This file does not contain build",
                    ...
                    ["db_load_helper_file_not_found"] = "Could not find DB file generated by the helper mod. Install mod, start server for generate necessary files by mod, and try again. Or disable use of the helper mod in settings",
                    ["tab_settings_helper_mod"] = "Helper mod",
                    ["tab_settings_helper_mod_enabled"] = "Using a helper mod",
                    ["tab_settings_helper_mod_status"] = "Mod status",
                    ["helper_mod_status_not_installed"] = "Not installed",
                    ["helper_mod_status_installed"] = "Installed",
                    ["helper_mod_status_outdated"] = "Update available",
                    ["helper_mod_install"] = "Install",
                    ["helper_mod_reinstall"] = "Reinstall",
                    ["helper_mod_update"] = "Update",
                    ["helper_mod_uninstall"] = "Delete",
            ...
            new AppLocalization
            {
                ...
                Translations = new Dictionary<string, string>()
                {
                    ...
                    ["tab_settings_auto_add_event_quests"] = "Добавление отсутствующих ивент квестов в профиль",
                    ...
                    ["tab_hideout_zones"] = "Зоны",
                    ["tab_hideout_crafts"] = "Крафты",
                    ["tab_hideout_end_product"] = "Конечный продукт",
                    ["tab_hideout_area"] = "Зона",
                    ["tab_hideout_level"] = "Уровень",
                    ["tab_hideout_maximum_button"] = "Установить все на максимум",
                    ["tab_hideout_add_all_crafts"] = "Добавить все крафты",
                    ...
                    ["tab_stash_modded_item_founded_error"] = "Найден предмет, добавленный модом. Воспользуйтесь разделом \"Очистка от модов\" для удаления таких предметов.",
                    ["tab_stash_quest_item"] = "Квестовый предмет",
                    ["tab_stash_add_to"] = "Добавить в",
                    ["tab_stash_search_include_description"] = "Искать в описании",
                    ["tab_stash_all_items"] = "Все предметы",
                    ["stash_type_stash"] = "Схрон ЧВК",
                    ["stash_type_questraiditems"] = "Квестовые предметы в инвентаре (в рейде)",
                    ["stash_type_queststashitems"] = "Квестовые предметы в инвентаре (вне рейда)",
                    ["all_items_description"] = "Данная функция позволяет добавить любой предмет из БД сервера",
                    ["all_items_warning"] = "Некоторые предметы могут повредить профиль. Используйте на свой страх и риск!",
                    ...
                    ["tab_clearing_from_mods_weapon_build"] = "Оружейная сборка",
                    ["tab_clearing_from_mods_equipment_build"] = "Сборка снаряжения",
                    ...
                    ["tab_clearing_from_mods_helper_mod_enabled"] = "Включено использование вспомогательного мода. В этом режиме отображаются только остатки удаленных модов. Отключить использование вспомогательного мода можно в настройках.",
                    ...
                    ["profile_saved_with_errors_dialog_caption"] = "Профиль сохранен с ошибками",
                    ["profile_not_saved_dialog_caption"] = "Не удалось сохранить профиль",
                    ["save_profile_dialog_ok"] = "OK",
                    ...
                    ["tab_presets_weapon_user"] = "Оружие (Пользовательские)",
                    ["tab_presets_weapon_global"] = "Оружие (Глобальные)",
                    ["tab_presets_equipment_user"] = "Снаряжение (Пользовательские)",
                    ["tab_presets_export"] = "Экспорт",
                    ["tab_presets_import"] = "Импорт",
                    ["tab_presets_add_to_stash"] = "Добавить в схрон",
                    ["tab_presets_weapons_empty"] = "В профиле отсутствуют сборки оружия",
                    ["tab_presets_equipment_empty"] = "В профиле отсутствуют сборки снаряжения",
                    ["tab_presets_file_not_build"] = "Этот файл не содержит сборку",
                    ...
                    ["db_load_helper_file_not_found"] = "Не удалось найти файл БД, сгенерированный вспомогательным модом. Установите мод, запустите сервер для генерации необходимых файлов модом и попробуйте еще раз. Или отключите использование вспомогательного мода в настройках",
                    ["tab_settings_helper_mod"] = "Вспомагательный мод",
                    ["tab_settings_helper_mod_enabled"] = "Использование вспомогательного мода",
                    ["tab_settings_helper_mod_status"] = "Статус мода",
                    ["helper_mod_status_not_installed"] = "Не установлен",
                    ["helper_mod_status_installed"] = "Установлен",
                    ["helper_mod_status_outdated"] = "Доступно обновление",
                    ["helper_mod_install"] = "Установить",
                    ["helper_mod_reinstall"] = "Переустановить",
                    ["helper_mod_update"] = "Обновить",
                    ["helper_mod_uninstall"] = "Удалить",
